...
// import {GitHubIcon, FacebookIcon, LinkedInIcon} from '@mui/icons-material';
...
<div className="container">
  <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <Link href="/" class="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
      <span className="mb-3 mb-md-0 text-muted">&copy; 2022 React App - Fernando Icazatti</span>
    </Link>
    <ContactIcons colorIcon='secondary' size='20'/>
